...
# ref: https://www.twilio.com/blog/2017/01/how-to-set-environment-variables.html 
#
# Description:
#
...
# of the dog in the frame, and texts the user's phone if a dog is
...
#from flask import Flask, Response #future implementation of live streaming
...
#Bell code to test duel functionality
...
# Define couch box coordinates (top left and bottom right)
TL_inside = (int(IM_WIDTH*0.1),int(IM_HEIGHT*0.2))
BR_inside = (int(IM_WIDTH*0.9),int(IM_HEIGHT*0.6))
...
### Live web cam feed feature for future development
#    app = Flask(__name__)
#    @app.route('/')
#    def index():
...
#    def video_feed():
#        global rawCapture
#        return Response(gen(rawCapture), mimetype='multipart/x-mixed-replace; boundary=frame')
...
### USB webcam to implement live web feed from picamera if two cameras are available ###
