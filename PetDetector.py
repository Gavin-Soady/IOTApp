...
TL_outside = (int(IM_WIDTH*0.1),int(IM_HEIGHT*0.65))
BR_outside = (int(IM_WIDTH*0.9),int(IM_HEIGHT*0.9))
...
def pet_detector(frame):
    ...
    if inside_counter > 1:
        ...
        pic = 1
        fileLoc = f'/home/pi/week10/img/frame{pic}.jpg' # set location of image file and current time
        ...
        message = client.messages.create(
            body = 'Monty is on the couch again... http://highfalutin-spark-wasp.glitch.me/',
            from_=twilio_number,
            to=my_number
            )
        inside_counter = 0
